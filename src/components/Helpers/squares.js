...
const squares = [
    Isometric_Square_turquoise,
    Isometric_Square_light_blue,
    Isometric_Square_orange,
    Isometric_Square_red,
    Isometric_Square_pink,
    Isometric_Square_raspberry,
    // Isometric_Square_caribbean_green
];
